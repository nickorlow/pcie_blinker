...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L blk_mem_gen_v8_4_5 -L fifo_generator_v13_1_4 -L xdma_v4_1_17 -L axi_bram_ctrl_v4_1_6 -L util_vector_logic_v2_0_2 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_28 -L xlconstant_v1_1_7 -L proc_sys_reset_v5_0_13 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_26 -L axi_vip_v1_1_12 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top -key {Behavioral:sim_1:Functional:top} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b43a.protoinst" -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/nickorlow/vivado/inst_22.01/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi

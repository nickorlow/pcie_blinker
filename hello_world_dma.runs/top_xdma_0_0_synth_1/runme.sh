...
HD_PWD='/home/nickorlow/vivado/hello_world_dma/hello_world_dma.runs/top_xdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_xdma_0_0.tcl
